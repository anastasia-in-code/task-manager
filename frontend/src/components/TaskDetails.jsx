...
export const TaskDetails = () => {
  ...
  const taskData = useMemo(() => tasks.find((task) => task.id === selectedTask), [tasks, selectedTask]);
        ...
        {taskData && (
          <Card.Body>
            ...
            >
              ...
              <div>
                <button onClick={handleTaskEdit} className="icon-btn" aria-label="Edit Task">
                  <svg
                ...
                <button onClick={handleTaskDelete} className="icon-btn" aria-label="Delete Task">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
